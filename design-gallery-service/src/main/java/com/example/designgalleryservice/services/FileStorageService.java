...
import com.example.designgalleryservice.configs.FileStorageProperties;
...
public class FileStorageService {
    ...
    private final Path fileDesignImageStorageLocation;
    ...
    public FileStorageService(FileStorageProperties fileStorageProperties) {
        ...
        this.fileThumbnailImageStorageLocation = Paths.get(fileStorageProperties.getUploadThumbnailImageDir())
                .toAbsolutePath().normalize();
        this.fileDesignImageStorageLocation = Paths.get(fileStorageProperties.getUploadDesignImageDir())
                .toAbsolutePath().normalize();
        try {
            ...
            Files.createDirectories(fileDesignImageStorageLocation);
        }catch (Exception ex){
    ...
    public  String storeDesignImageFile(MultipartFile file){
        return storeFile(fileDesignImageStorageLocation,file);
    }
    ...
    public Resource loadDesignImageFileAsResource(String filename){
        return  loadFileAsResource(fileDesignImageStorageLocation,filename);
    }
    ...
    public void deleteDesignImageFile(String filename){
        deleteFile(fileDesignImageStorageLocation,filename);
    }
