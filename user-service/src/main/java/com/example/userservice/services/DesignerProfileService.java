...
public interface DesignerProfileService {
    ...
    DesignerProfileResponse updateStatusDesignerProfile(Long id, DesignerProfileStatus status);
    ...
    List<DesignerProfileResponse> getByStatus(DesignerProfileStatus status);
}
